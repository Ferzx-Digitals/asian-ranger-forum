      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-14">
        ...
        <section className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {sessionTypes.map((s) => (
              <div key={s.type} className="rounded-sm border border-border bg-card p-5 text-center flex flex-col items-center">
                ...
                <p className="font-body text-sm text-muted-foreground leading-relaxed max-w-md">{s.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="overflow-hidden py-4 -mx-4 sm:-mx-6 text-center">
          <div className="px-4 sm:px-6 mb-8">
            <h2 className="font-display text-2xl font-bold text-primary mb-2">Thematic Areas</h2>
