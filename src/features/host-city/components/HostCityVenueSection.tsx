...
export function HostCityVenueSection() {
  return (
    <section
      ...
      className="relative overflow-hidden border-y border-primary-foreground/10 bg-primary text-primary-foreground"
    >
      <div
        aria-hidden="true"
        className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-secondary/10 blur-3xl"
      />
      <div
        aria-hidden="true"
        className="absolute -bottom-32 -left-24 h-80 w-80 rounded-full bg-primary-foreground/5 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:gap-16">
          <div>
            ...
            <h2
              ...
              className="max-w-xl font-display text-4xl font-bold leading-none text-primary-foreground sm:text-5xl"
            >
              Majestic Thimphu Hosts You
            </h2>

            <p className="mt-6 max-w-xl font-body text-base leading-7 text-primary-foreground/75">
            ...
            <Link
              ...
              className="mt-8 inline-flex min-h-11 items-center justify-center gap-2 rounded-sm bg-secondary px-5 font-body text-sm font-semibold text-secondary-foreground hover:bg-secondary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
            >
          ...
          <div>
            <figure className="relative aspect-[4/3] overflow-hidden rounded-sm border border-primary-foreground/15 bg-primary-foreground/5 sm:aspect-[16/10]">
              <Image
        ...
        <dl className="mt-12 grid border-t border-primary-foreground/15 pt-8 sm:grid-cols-3 sm:divide-x sm:divide-primary-foreground/15 lg:mt-16">
          {hostFacts.map((fact) => {
            ...
            return (
              <div
                key={fact.label}
                className="flex items-center gap-4 border-b border-primary-foreground/10 py-4 last:border-b-0 sm:border-b-0 sm:px-6 sm:first:pl-0 sm:last:pr-0"
              >
                <Icon
                  aria-hidden="true"
                ...
                />
                <div>
                  <dt className="font-body text-xs uppercase tracking-[0.18em] text-primary-foreground/60">
                    {fact.label}
                  </dt>
                  <dd className="mt-1 font-display text-2xl font-bold text-primary-foreground">
                    {fact.value}
                  </dd>
                </div>
              </div>
